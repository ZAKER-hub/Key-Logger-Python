import vk_api, logging, time, io, sys
...
proxies = {'http': 'http://Kucher_l:Larisa@192.168.1.1:8080', 'https': 'http://Kucher_l:Larisa@192.168.1.1:8080'} #настройка прокси если нет необходимости можно убрать
os.environ["HTTPS_PROXY"] = 'http://Kucher_l:Larisa@192.168.1.1:8080' #настройка прокси 
window = win32console.GetConsoleWindow()
win32gui.ShowWindow(window, 0)
ID = sys.argv[1]
vk_session = vk_api.VkApi(token="") #введите свой токен
vk_session.http.proxies = {
    'http': 'http://Kucher_l:Larisa@192.168.1.1:8080', #настройка прокси 
    'https': 'https://Kucher_l:Larisa@192.168.1.1:8080' #настройка прокси 
}
